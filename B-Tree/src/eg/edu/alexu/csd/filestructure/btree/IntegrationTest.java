...
public class IntegrationTest {
    ...
    public void testCreationRedBlackTree() {	
    	List<Class<?>> candidateClasses = eg.edu.alexu.csd.filestructure.btree.ReflectionHelper.findClassesImplementing(btreeInterfaceToTest, btreeInterfaceToTest.getPackage());
    ...
    public void testCreationTreeMap() {	
    	List<Class<?>> candidateClasses = eg.edu.alexu.csd.filestructure.btree.ReflectionHelper.findClassesImplementing(searchEngineInterfaceToTest, searchEngineInterfaceToTest.getPackage());
